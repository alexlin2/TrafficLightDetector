...
class Predictor():
    ...
    def __init__(self, threshold = 0.5, write_dir = 'results/'):
...
if __name__ == "__main__":
    ...
    p1 = Predictor()
    img = p1.read_img('/home/alexlin/traffic_net/dataset_train_rgb/rgb/train/2015-10-05-10-52-01_bag/25914.png')
